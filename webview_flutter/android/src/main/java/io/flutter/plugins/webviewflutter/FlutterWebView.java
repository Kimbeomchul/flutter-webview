...
import android.net.Uri; import android.webkit.ValueCallback;
...
public class FlutterWebView implements PlatformView, MethodCallHandler {
    ...
    private class FlutterWebChromeClient extends WebChromeClient {
        ...
        @Override
        public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, FileChooserParams fileChooserParams) { // info as of 2021-03-08:
            final Context context = webView.getContext();
            final boolean allowMultipleFiles = Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && fileChooserParams.getMode() == FileChooserParams.MODE_OPEN_MULTIPLE;
            final String[] acceptTypes = Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP ? fileChooserParams.getAcceptTypes() : new String[0];
